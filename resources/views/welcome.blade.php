    ...
    * {
    ...
    @media(max-width:900px) {
      ...
      .nav-links a {
        width: 100%;
        padding: 16px 28px;
        border-bottom: 1px solid rgba(217, 203, 180, .08);
      }
      .nav-cta {
        margin: 16px 28px;
    ...
    .btn-primary:hover {
      ...
      box-shadow: 0 12px 24px -8px rgba(199, 123, 61, .5);
    }
    .btn-ghost {
    ...
    .panel-ivory .section-head h2 {
      color: var(--ink);
    }
    .panel-ivory .section-head p {
      color: var(--ink-soft);
    }
    .about {
      display: grid;
    ...
    .identity-card.boys {
      background: linear-gradient(160deg, rgba(199, 123, 61, .16), rgba(199, 123, 61, .03));
    }
    .identity-card.girls {
      background: linear-gradient(200deg, rgba(140, 47, 57, .18), rgba(140, 47, 57, .04));
    }
    ...
    .contact-card.boys-c .tag-pill {
      background: var(--amber);
      color: var(--ink);
    }
    .contact-card.girls-c .tag-pill {
      background: var(--rose);
      color: var(--ivory);
    }
    .contact-card h3 {
