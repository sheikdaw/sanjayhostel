...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .gallery-grid a { overflow: hidden; border-radius: var(--radius-lg); transition: transform 0.3s ease, box-shadow 0.3s ease; }
        .gallery-grid a:hover { transform: scale(1.02); box-shadow: var(--shadow-lg); }
        .gallery-grid img { width: 100%; height: 100%; object-fit: cover; }
        .gallery-grid .g1 { grid-column: span 2; grid-row: span 2; }
        .gallery-grid .g5 { grid-column: span 2; }
        @media (max-width: 700px) {
            .gallery-grid { grid-template-columns: repeat(2, 1fr); grid-auto-rows: 140px; }
            .gallery-grid .g1 { grid-column: span 1; grid-row: span 1; }
            .gallery-grid .g5 { grid-column: span 1; }
        }
