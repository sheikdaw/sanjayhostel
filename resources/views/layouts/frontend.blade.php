...
<head>
    ...
    <style>
        /* ============================================================
        Sanjay & Harini Hostels — Complete Design System
        ============================================================ */
        ...
        * {
        ...
        .site-nav.on-hero .brand,
        .site-nav.on-hero .nav-links a:not(.cta) {
            color: var(--cream);
        }
        ...
        .site-nav.on-hero.scrolled {
            ...
            box-shadow: 0 2px 20px rgba(34, 29, 24, 0.08);
            padding: 14px 0;
        }

        .site-nav.on-hero.scrolled .brand,
        .site-nav.on-hero.scrolled .nav-links a:not(.cta) {
            color: var(--ink);
        }
        ...
        .site-nav.solid {
            ...
            backdrop-filter: blur(8px);
            box-shadow: 0 2px 20px rgba(34, 29, 24, 0.06);
        }
        ...
        @media (max-width: 820px) {
            ...
            .site-nav.on-hero .nav-toggle {
                color: var(--cream);
            }

            .site-nav.on-hero.scrolled .nav-toggle {
                color: var(--ink);
            }
        }
        ...
        .hero-bg .side.left::after {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(0deg, rgba(34, 20, 10, 0.65), rgba(34, 20, 10, 0.25));
        }
        ...
        .hero-bg .side.right::after {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(0deg, rgba(40, 15, 22, 0.65), rgba(40, 15, 22, 0.25));
        }
        ...
        .hero h1 em {
            font-style: normal;
            background: linear-gradient(100deg, var(--amber) 10%, var(--rose) 90%);
        ...
        .final-cta::before {
            ...
            height: 900px;
            margin-left: -450px;
            background: radial-gradient(circle, rgba(184, 60, 82, 0.35), transparent 60%);
            z-index: 0;
        }
        ...
        <div class="wrap">
            <div class="foot-grid">
                <div>
                    ...
                    <p>Safe, affordable PG accommodation for men and women in Alandur, St. Thomas Mount and
                        Perungalathur, Chennai.</p>
                </div>
                <div>
                    <h5>Quick Links</h5>
                    <ul>
    ...
    <a href="{{ route('privacy') }}">Privacy Policy</
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li>📧 info@sanjayandharinihostels.com</li>
